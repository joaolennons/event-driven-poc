...
namespace Insurance.Query
{
    public class NeurotechIntegrationHandler
    {
        ...
        public NeurotechIntegrationHandler(IHttpClientFactory httpClientFactory, IEventBroker eventBroker, IAggregateRootRepository repository)
        {
        ...
        public async Task Run([QueueTrigger("QuotationPlanCalculationRequested", Connection = "AzureWebJobsStorage")] string message,
